...
policy-tests:
	python3 -m unittest tests.test_attest_n8n_policy tests.test_community_runtime_policy tests.test_compose_semantics tests.test_integration_contracts tests.test_middleware_surface tests.test_policy_guards tests.test_ruleset_contract tests.test_runtime_path_audit tests.test_runtime_path_privileged_stat tests.test_shared_templates tests.test_umbrella_readback
